...
func (sq *ServiceQuery) QueryOwner() *UserQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, true, service.OwnerTable, service.OwnerColumn),
		)
...
func (sq *ServiceQuery) WithOwner(opts ...func(*UserQuery)) *ServiceQuery {
	query := (&UserClient{config: sq.config}).Query()
...
func (sq *ServiceQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Service, error) {
	...
	if query := sq.withOwner; query != nil {
		if err := sq.loadOwner(ctx, query, nodes, nil,
			func(n *Service, e *User) { n.Edges.Owner = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (sq *ServiceQuery) loadOwner(ctx context.Context, query *UserQuery, nodes []*Service, init func(*Service), assign func(*Service, *User)) error {
